...
import { days } from 'artalk/i18n/ja'
      ...
      <section class="hero">
        ...
        <div class="search-wrapper">
          <div class="search-box">
            ...
            <input type="text" class="search-input" placeholder="搜索网站名称或关键词..." v-model="searchQuery"
              @input="onSearchInput" ref="searchInputRef" />
        ...
        <!-- <div class="quick-tags" v-if="!searchQuery">
          <span v-for="tag in quickTags" :key="tag.keyword" class="quick-tag" @click="handleQuickTag(tag.keyword)">{{
            tag.label }}</span>
        </div> -->
      </section>
