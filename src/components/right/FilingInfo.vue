<!--
 * @Author: chenjie
 * @Date: 2026-05-09 14:35:27
 * @LastEditors: 橘子orange
 * @LastEditTime: 2026-05-09 16:09:41
 * @FilePath: \bbs-vue3-ui\src\components\right\FilingInfo.vue
 * @Description: xxx
-->
<template>
...
<a-col class="user_guidance" :span="6">
  <a href="https://www.bilibili.com/video/BV1he4y1C7rk?spm_id_from=333.999.0.0&vd_source=d0a5d07985a7fbbfb889c874632343c6"
    target="_blank">{{ $t("common.userGuidance") }}</a>
</a-col>
...
<a-col class="about_us" :span="6" @click="routerAbout">{{ $t("common.about") }}</a-col>
    ...
    <a-row>
      版权 © <a href="/" target="_blank"> 橘享论坛 </a>丨
      <a href="https://beian.miit.gov.cn" target="_blank">蜀ICP备2022021714号-1 </a>Copyright © 2022-2026 by orange
    </a-row>
  </div>
</template>
